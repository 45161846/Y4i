...
class SpellingRepositoryImpl: SpellingRepository {
    ...
    override fun getWordSpellings(wordId: Int): List<Spelling> {
        TODO("Not yet implemented")
    }

    override fun addSpellingVariant(spelling: Spelling) {
        TODO("Not yet implemented")
    }

    override fun addSpellingVariants(spellings: List<Spelling>) {
        TODO("Not yet implemented")
    }
